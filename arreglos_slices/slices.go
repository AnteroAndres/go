...
func MuestroSlice(){
	...
	porcion2 := arreglo[:5] //slice crewado desde un vector, desde la posicion 0 hasta la 5
	porcion3 := arreglo[6:7] // slice creado desde un vector, desde la posicion 6 hasta 7
